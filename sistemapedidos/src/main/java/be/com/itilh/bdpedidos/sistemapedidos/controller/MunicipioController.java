...
import be.com.itilh.bdpedidos.sistemapedidos.repository.MunicipioRepository;

import be.com.itilh.bdpedidos.sistemapedidos.model.Municipio;
...
public class MunicipioController {
    ...
    @GetMapping("/municipios/estadonome/{nome}")
